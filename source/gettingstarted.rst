...
--------------------------------------------
With this option, the user can install all the necessary modules themself and then the path to their python or environment (e.g. Conda) can be provided as an instruction.
